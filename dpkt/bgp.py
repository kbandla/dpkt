...
# BGP-EVPN type 1-5 packets for testing.
...
__bgp6 = b''
...
__bgp9 = b''
...
def test_unpack():
    ...
    assert (r.ip_address_length == 32)
    assert (r.ip_address == '\xc0\xb4\x01\x02')
    assert (r.gateway_ip_address == '\xc0\xb5\x01\x01')
    assert (r.mpls_label_stack == '\x00\x00\x02')
