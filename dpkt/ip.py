...
# Dictionary containing IP Protocol Name
dictProtoName = {0:'IP_PROTO_IP', 1:'IP_PROTO_HOPOPTS', 2:'IP_PROTO_ICMP', 3:'IP_PROTO_IGMP', 4:'IP_PROTO_GGP', 5:'IP_PROTO_IPIP', 6:'IP_PROTO_ST', 7:'IP_PROTO_TCP', 8:'IP_PROTO_CBT', 9:'IP_PROTO_EGP', 10:'IP_PROTO_IGP', 11:'IP_PROTO_BBNRCC', 12:'IP_PROTO_NVP', 13:'IP_PROTO_PUP', 14:'IP_PROTO_ARGUS', 15:'IP_PROTO_EMCON', 16:'IP_PROTO_XNET', 17:'IP_PROTO_CHAOS', 18:'IP_PROTO_UDP', 19:'IP_PROTO_MUX', 20:'IP_PROTO_DCNMEAS', 21:'IP_PROTO_HMP', 22:'IP_PROTO_PRM', 23:'IP_PROTO_IDP', 24:'IP_PROTO_TRUNK1', 25:'IP_PROTO_TRUNK2', 26:'IP_PROTO_LEAF1', 27:'IP_PROTO_LEAF2', 28:'IP_PROTO_RDP', 29:'IP_PROTO_IRTP', 30:'IP_PROTO_TP', 31:'IP_PROTO_NETBLT', 32:'IP_PROTO_MFPNSP', 33:'IP_PROTO_MERITINP', 34:'IP_PROTO_SEP', 35:'IP_PROTO_3PC', 36:'IP_PROTO_IDPR', 37:'IP_PROTO_XTP', 38:'IP_PROTO_DDP', 39:'IP_PROTO_CMTP', 40:'IP_PROTO_TPPP', 41:'IP_PROTO_IL', 42:'IP_PROTO_IP6', 43:'IP_PROTO_SDRP', 44:'IP_PROTO_ROUTING', 45:'IP_PROTO_FRAGMENT', 46:'IP_PROTO_RSVP', 47:'IP_PROTO_GRE', 48:'IP_PROTO_MHRP', 49:'IP_PROTO_ENA', 50:'IP_PROTO_ESP', 51:'IP_PROTO_AH', 52:'IP_PROTO_INLSP', 53:'IP_PROTO_SWIPE', 54:'IP_PROTO_NARP', 55:'IP_PROTO_MOBILE', 56:'IP_PROTO_TLSP', 57:'IP_PROTO_SKIP', 58:'IP_PROTO_ICMP6', 59:'IP_PROTO_NONE', 60:'IP_PROTO_DSTOPTS', 61:'IP_PROTO_ANYHOST', 62:'IP_PROTO_CFTP', 63:'IP_PROTO_ANYNET', 64:'IP_PROTO_EXPAK', 65:'IP_PROTO_KRYPTOLAN', 66:'IP_PROTO_RVD', 67:'IP_PROTO_IPPC', 68:'IP_PROTO_DISTFS', 69:'IP_PROTO_SATMON', 70:'IP_PROTO_VISA', 71:'IP_PROTO_IPCV', 72:'IP_PROTO_CPNX', 73:'IP_PROTO_CPHB', 74:'IP_PROTO_WSN', 75:'IP_PROTO_PVP', 76:'IP_PROTO_BRSATMON', 77:'IP_PROTO_SUNND', 78:'IP_PROTO_WBMON', 79:'IP_PROTO_WBEXPAK', 80:'IP_PROTO_EON', 81:'IP_PROTO_VMTP', 82:'IP_PROTO_SVMTP', 83:'IP_PROTO_VINES', 84:'IP_PROTO_TTP', 85:'IP_PROTO_NSFIGP', 86:'IP_PROTO_DGP', 87:'IP_PROTO_TCF', 88:'IP_PROTO_EIGRP', 89:'IP_PROTO_OSPF', 90:'IP_PROTO_SPRITERPC', 91:'IP_PROTO_LARP', 92:'IP_PROTO_MTP', 93:'IP_PROTO_AX25', 94:'IP_PROTO_IPIPENCAP', 95:'IP_PROTO_MICP', 96:'IP_PROTO_SCCSP', 97:'IP_PROTO_ETHERIP', 98:'IP_PROTO_ENCAP', 99:'IP_PROTO_ANYENC', 100:'IP_PROTO_GMTP', 101:'IP_PROTO_IFMP', 102:'IP_PROTO_PNNI', 103:'IP_PROTO_PIM', 104:'IP_PROTO_ARIS', 105:'IP_PROTO_SCPS', 106:'IP_PROTO_QNX', 107:'IP_PROTO_AN', 108:'IP_PROTO_IPCOMP', 109:'IP_PROTO_SNP', 110:'IP_PROTO_COMPAQPEER', 111:'IP_PROTO_IPXIP', 112:'IP_PROTO_VRRP', 113:'IP_PROTO_PGM', 114:'IP_PROTO_ANY0HOP', 115:'IP_PROTO_L2TP', 116:'IP_PROTO_DDX', 117:'IP_PROTO_IATP', 118:'IP_PROTO_STP', 119:'IP_PROTO_SRP', 120:'IP_PROTO_UTI', 121:'IP_PROTO_SMP', 122:'IP_PROTO_SM', 123:'IP_PROTO_PTP', 124:'IP_PROTO_ISIS', 125:'IP_PROTO_FIRE', 126:'IP_PROTO_CRTP', 127:'IP_PROTO_CRUDP', 128:'IP_PROTO_SSCOPMCE', 129:'IP_PROTO_IPLT', 130:'IP_PROTO_SPS', 131:'IP_PROTO_PIPE', 132:'IP_PROTO_SCTP', 133:'IP_PROTO_FC', 134:'IP_PROTO_RSVPIGN'}

# XXX - auto-load IP dispatch table from IP_PROTO_* definitions

# Function for getting back IP Protocol Name
# It requires the Protocol Number and returns Protocol Name
def getIpProtoName(protoNum):
    try: return dictProtoname[protoNum]
    except (KeyError): return 'Unknown IP Layer Protocol'
