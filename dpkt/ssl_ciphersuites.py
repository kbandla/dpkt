...
class CipherSuite(object):
    ...
    * cipher: stream or block cipher algorithm, as 'AES_128'
    * mode: mode of operation for block ciphers, as 'CBC' or 'GCM'
    * mac: message authentication code algorithm
    * name: as in 'TLS_RSA_WITH_RC4_40_MD5', can be generated by default from
